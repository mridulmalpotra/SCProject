...
class UserProfile(models.Model):
    ...
    def __unicode__(self):
        ...
        res = '{"Name" : "' + str(userData.first_name) + " " + str(userData.last_name) + '", \
        "Roll No" : "' + str(self.roll_no) + '", "Email" : "' + str(userData.email)
...
class Events(models.Model):
    ...
    def __unicode__(self):
        ...
        name = User.objects.get(pk=postedby.user_id).first_name + " " + User.objects.get(pk=\
            postedby.user_id).first_name
        res = '{"EventID" : ' + str(self.eventid) + ', "Event Name" : "' + str(self.eventName) + \
        '", "Event Description" : "' + str(self.eventDescription)
        res = res + '", "Event Date" : "' + str(self.eventDate) + '", "Event Time" : "' + \
        str(self.eventTime) + '", "Posted By" : "' + str(name) + '"}'
        return res
